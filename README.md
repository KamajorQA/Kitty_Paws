...
Кроме того, в RTK Query API реализована функция изменения отдельной записи `updateCatLike` (постановка/снятие лайка с добавлением/удалением лайкнувшего пользователя в соответствующем массиве в БД).
Постановка и снятие лайка доступны на главной странице и на странице конкретного кота с синхронизацией данных.
